...
const PageHeader = ({ eyebrow, title, description }: PageHeaderProps) => (
  <section className="pt-40 pb-20 md:pt-52 md:pb-28 border-b border-border/60 relative overflow-hidden">
    ...
    <div className="container relative">
      ...
      {description && (
        <p className="mt-8 max-w-2xl text-lg text-muted-foreground leading-relaxed animate-fade-in" style={{ animationDelay: "200ms" }}>
          {description}
        </p>
      )}
    </div>
